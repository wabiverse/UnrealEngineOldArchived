...
PATH_TVOS_TOOLCHAIN=$CUR_PATH
PATH_TVOS_TOOLCHAIN=`cd "$PATH_TVOS_TOOLCHAIN"; pwd`
echo PATH_TVOS_TOOLCHAIN=$PATH_TVOS_TOOLCHAIN
...
cd $MAKE_PATH_DEBUG
cmake -G"Unix Makefiles" -DCMAKE_TOOLCHAIN_FILE=$PATH_TVOS_TOOLCHAIN/tvOS.cmake -DCMAKE_BUILD_TYPE="Debug" -DCMAKE_C_COMPILER="/usr/bin/clang" -DCMAKE_CXX_COMPILER="/usr/bin/clang++" -DCMAKE_CXX_FLAGS="$CXXFLAGS" -DCMAKE_TVOS_DEPLOYMENT_TARGET=10.0 $PATH_TO_CMAKE_FILE
...
cmake -G"Unix Makefiles" -DCMAKE_TOOLCHAIN_FILE=$PATH_TVOS_TOOLCHAIN/tvOS.cmake -DCMAKE_BUILD_TYPE="Release" -DCMAKE_C_COMPILER="/usr/bin/clang" -DCMAKE_CXX_COMPILER="/usr/bin/clang++" -DCMAKE_CXX_FLAGS="$CXXFLAGS" -DCMAKE_TVOS_DEPLOYMENT_TARGET=10.0 $PATH_TO_CMAKE_FILE
